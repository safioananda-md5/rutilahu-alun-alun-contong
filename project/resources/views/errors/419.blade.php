...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/errors/419.png') }}" type="image/png">
    ...
    <div class="text-center">
        ...
        <figure class="text-end">
            <blockquote class="blockquote">
                <p class="h1 text-info text-3d">419</p>
            </blockquote>
            <figcaption class="blockquote-footer">
                <cite title="Source Title">Page Expired!</cite> Halaman telah kadaluarsa
            </figcaption>
        </figure>
