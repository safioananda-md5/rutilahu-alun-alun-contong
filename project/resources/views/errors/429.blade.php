...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/errors/429.png') }}" type="image/png">
    ...
    <div class="text-center">
        ...
        <figure class="text-end">
            <blockquote class="blockquote">
                <p class="h1 text-primary text-3d">429</p>
            </blockquote>
            <figcaption class="blockquote-footer">
                <cite title="Source Title">Rate limit!</cite> Terlalu banyak permintaan dilakukan
            </figcaption>
        </figure>
