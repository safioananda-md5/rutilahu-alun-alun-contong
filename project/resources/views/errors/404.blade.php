...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/errors/404.png') }}" type="image/png">
    ...
    <div class="text-center">
        ...
        <figure class="text-end">
            <blockquote class="blockquote">
                <p class="h1 text-danger text-3d">404</p>
            </blockquote>
            <figcaption class="blockquote-footer">
                <cite title="Source Title">Opps!</cite> Halaman tidak ditemukan
            </figcaption>
        </figure>
