        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="image-generator.html"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>
                            Image Generator</a>
                    </li>
                    <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="internal-server.html"><i
                                class="ri-circle-fill circle-icon text-primary-main w-auto"></i> Internal Server</a>
                    </li>
                    <li>
                        <a href="service-unavailable.html"><i
                                class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Service Unavailable</a>
                    </li>
                </ul>
            </li>
            <li>
