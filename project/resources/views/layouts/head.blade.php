...
<link rel="icon" type="image/png" href="{{ asset('assets/images/official/off_logo_surabaya.png') }}">
...
<link rel="stylesheet" href="{{ asset('assets/vendors/nice-select2/nice-select2.min.css') }}">
