<div class="card-body p-0 d-flex flex-column" wire:poll.10s>
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <h6 class="fw-semibold mb-2">{{ $countsubmissions }}</h6>
                <span class="fw-medium text-secondary-light text-sm">
                    Total Warga Mengajukan Bantuan
                </span>
            </div>
        </div>
    </div>
    <p class="text-sm mb-0 mt-auto px-3 pb-2">
        <span class="text-cyan-600">{{ $countsubmissionsthisweek }}</span>
        Warga mengajukan minggu ini.
    </p>
</div>
