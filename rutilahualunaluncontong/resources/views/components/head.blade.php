<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/images/icon/icon-surabaya.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/icon/icon-surabaya.png') }}">
